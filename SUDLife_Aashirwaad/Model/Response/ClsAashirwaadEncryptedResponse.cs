...
{
    public class ClsAashirwaadEncryptedResponse
    {
        
            public ClsAashirwaadEncryptedResponse()
            {

            }
            public ClsAashirwaadEncryptedResponse(int StatusCode, string sourceName, string encryptResSign)
            {
